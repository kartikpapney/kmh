<?php require_once ('pagetop.php'); ?>
			...
			<div id="mainab">
				...
				<div class="wrapperab">
					...
					<div class="clear"></div>
					<div id="headline">
						<span class="main" style="text-align:justify" id="Canteen">Canteen</span>
							...
							<div class="panes">
								...
								<div>
									<div class="plain-text">
										<p class="content_text" style="text-align:justify">There is a utility shop in the ground floor of the hostel with all the facilities essential for the boarders of the hostel. The shop provides 24 hours of service during the examination period to facilitate the needs.</p>
									</div>
								</div>
								<!-- ENDS Information -->
							</div>
